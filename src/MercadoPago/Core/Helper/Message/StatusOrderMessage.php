...
class StatusOrderMessage extends AbstractMessage
{
    ...
    protected $messagesMap = [
        ...
        "in_process"   => 'Automatic notification of the Mercado Pago: The payment is being processed. Will be '
            . 'approved within 2 business days.',
        "in_mediation" => 'Automatic notification of the Mercado Pago: The payment is in the process of Dispute, check '
