 ...
 */
class StatusDetailMessage extends \MercadoPago\Core\Helper\Message\AbstractMessage
{
    /**
     * Map error messages
     *
    ...
    protected $messagesMap = [
        ...
        "cc_rejected_card_disabled"            => 'Call %1 to activate your card.<br/>The phone is on the back of your '
            . 'card.',
        "cc_rejected_card_error"               => 'We could not process your payment.',
        "cc_rejected_duplicated_payment"       => 'You already made a payment by that value.<br/>If you need to repay, '
            . 'use another card or other payment method.',
        "cc_rejected_high_risk"                => 'Your payment was rejected.<br/>Choose another payment method, we '
            . 'recommend cash methods.',
        ...
        "cc_rejected_max_attempts"             => 'You have got to the limit of allowed attempts.<br/>Choose another '
